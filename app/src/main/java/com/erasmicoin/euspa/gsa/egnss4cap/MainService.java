...
import static com.erasmicoin.euspa.gsa.egnss4cap.BaseActivity.SERVER_BASE_URL;
...
import com.erasmicoin.euspa.gsa.egnss4cap.model.LoggedUser;
...
import com.erasmicoin.euspa.gsa.egnss4cap.model.SyncQueue;
import com.erasmicoin.euspa.gsa.egnss4cap.model.Task;
import com.erasmicoin.euspa.gsa.egnss4cap.model.TaskList;
...
public class MainService extends Service {
    ...
    private void loadTasks(final SyncQueue syncQueue) {
        requestor.requestAuth(SERVER_BASE_URL+"comm_tasks.php", new Response.Listener<String>() {
            @Override
    ...
    private void downloadPaths() {
        ...
        requestor.requestAuth(SERVER_BASE_URL+"comm_get_paths.php", new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                try {
                    JSONObject jsonObject = new JSONObject(response);
